...
class MongoAttribute(DatabaseAttribute):
    """A MongoAttribute can be used within a model to specify where the value is
    ...
    def load(self, base_response, _attribute_response):
        ...
        # the base request
        value = JSONPath(self.path).parse(base_response.value)
