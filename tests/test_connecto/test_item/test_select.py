...
class TestDatabaseItemSelect(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.item_mapper.select_request.return_value = self.base_request
        ...
        for i in range(6):
            self.attribute_mocks[i].select_request.return_value = (
                self.attribute_requests[i]
            )

    def test_select_request_single_attribute_model(self):
        ...
        assert_that(
            select_requests,
            contains_exactly(
                self.item_mapper.select_request.return_value, self.attribute_requests[0]
            ),
        )

    def test_select_request_with_none_request(self):
        ...
        self.attribute_mocks[0].select_request.return_value = None
        ...
        assert_that(
            select_requests,
            contains_exactly(self.item_mapper.select_request.return_value, None),
        )
    ...
    def test_select_request_simple_tuple_model(self):
        """Tests the validity of built select requests for a tuple model."""
    ...
    def test_select_request_simple_dict_model(self):
    ...
    def test_select_request_with_complex_nested_attributes(self):
    ...
    def test_select_multiple_request_attribute(self):
        """Tests the validity of built select requests for a model with
        attributes that require multiple requests nested in dicts and lists.
        """
        self.attribute_mocks[0].select_request.return_value = {
            "request1": self.attribute_requests[0],
            "request2": self.attribute_requests[1],
        }
        self.attribute_mocks[1].select_request.return_value = [
            self.attribute_requests[2],
    ...
    def _test_select_request_simple_list_or_tuple_model_with_constants(
    ...
    def test_select_request_simple_tuple_model_with_constants(self):
        """Tests the validity of built select requests for a tuple model with
        constants."""
        self._test_select_request_simple_list_or_tuple_model(tuple)

    def test_select_request_simple_list_model_with_constants(self):
        """Tests the validity of built select requests for a list model with
        constants."""
        self._test_select_request_simple_list_or_tuple_model(list)

    def test_select_request_simple_dict_model_with_constants(self):
        """Tests the validity of built select requests for a dict model with
        constants."""
        database_item = DatabaseItem(
            self.item_mapper,
            {
    ...
    def test_select_request_with_complex_nested_attributes_with_constants(self):
        """Tests the validity of built select requests for a model with
        attributes and constants nested in dicts and lists.
        """
        database_item = DatabaseItem(
            self.item_mapper,
            {
